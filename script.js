...
const RATES = { USD: 1, AED: 3.67, SAR: 3.75, QAR: 3.64, KWD: 0.306, BHD: 0.376, OMR: 0.384 };
// Currency symbols (English only)
const SYMBOLS = { USD: "$", AED: "AED", SAR: "SAR", QAR: "QAR", KWD: "KWD", BHD: "BHD", OMR: "OMR" };
// Country cost multipliers vs. USD baseline
const COUNTRY_MULTIPLIER = { UAE: 1, Saudi: 0.85, Qatar: 0.95, Kuwait: 0.95, Oman: 0.75, Bahrain: 0.8 };
// Baseline monthly costs in USD for one adult
const BASELINE_USD = {
...
// Format money with English symbol
